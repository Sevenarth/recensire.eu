...
export default class Query extends React.Component {
    ...
    render() {
        ...
        return <div ref={ref => this.container = ref} className="card mb-4">
            <h5 style={{backgroundColor: "rgba(0, 0, 0, 0.1)"}} className={"card-header" + (!this.state.edit ? ' pointer' : '')} onClick={e => !this.state.edit && this.setState({collapsed: !this.state.collapsed})}>
                {this.state.edit ?
            ...
            <div className={this.state.edit ? undefined : ("collapse" + (!this.state.collapsed ? ' show' : ''))}>
