...
@section('content')
  ...
  <div class="px-4 py-3">
    ...
    <table class="table table-sm table-striped">
      ...
      <tbody>
<<<<<<< HEAD
        @foreach($testOrder->testUnits()->where(function($q) { $q->where(function($q) { $q->where('status', '<>', 3)->where('status', '>', 0); })->orWhere(function($q) { $q->where('status', 0)->where('expires_on', '>', \Carbon\Carbon::now(config('app.timezone'))); }); })->get() as $unit)
=======
...
>>>>>>> 6b237a9e840c11036c90781ab7cd237c35f936ce
        <tr>
