...
class TestUnitFormRequest extends FormRequest
{
    ...
    {
        return [
            'starts_on_date' => 'nullable|required_with:starts_on_time|date',
            'starts_on_time' => 'nullable|required_with:starts_on_date|date_format:H:i',
            ...
            'amazon_order_id' => 'nullable|string|max:191',
            'refunded_amount' => 'nullable|numeric',
            'paypal_account' => 'nullable|email|max:191',
